...
,p_last_upd_yyyymmddhh24miss=>'20210922054003'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(286600981152137948)
,p_plug_name=>'Right'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--noBorder:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(123590440289713011)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(286601194834137950)
,p_plug_name=>'Middle'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--noBorder:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(123590440289713011)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(148000534642535293)
,p_name=>'P125_TEST_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(286600257237137941)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(148001678531535404)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(148001805470535406)
,p_name=>'AUTO_SUBMIT'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(148002306714535415)
,p_event_id=>wwv_flow_api.id(148001805470535406)
,p_event_result=>'TRUE'
